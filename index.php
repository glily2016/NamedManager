...
<script type="text/javascript" src="external/jquery/jquery.jeditable.js""></script>
...
//		  loadtype : 'GET',
		 ...
		 submitdata:function(value,settings){
			 $("#tip").text(
                 "id="+$(this).attr('id')+"&"+
				 "filed="+$(this).attr('field')
			);
			 return {id:$(this).attr('id'),field:$(this).attr('field')};
		 },            
		 calback: function(value,settings){
